(function($) {
    ...
    var all_questions = [{
        ...
        question_string: 'Why is a firewall used in a computer?',
        choices: {
            correct: "security",
            wrong: [" data transmission", " Authority", "Monitoring "]
        }
    }, {
        question_string: 'The full form of DOM is?',
        choices: {
            correct: "document object model",
            wrong: ["Document oriented memory", "Document object memory", " None"]
        }
    }, {
        question_string: 'Choose the port number of FTP?',
        choices: {
            correct: "21",
            wrong: ["23", " 120", "32 "]
        }
    }, {
        question_string: 'What is the full form of HTML?',
        choices: {
            correct: "Hypertext Markup Language",
            wrong: ["Hyper makeup Language ", "Hey text Madeup Language ", " Hypertect Markup Language"]
        }
    }, {
        question_string: ' What is the full form of IOT ?',
        choices: {
            correct: "Internet of Things",
            wrong: ["Internet of Technology ", "Internet of Think ", " Information of Technology"]
        }
    }];
